...
/**
 * DWD层数据处理器 - 关键词搜索查看更多商品数据
 * 使用 RichMapFunction 管理生命周期，避免类加载器泄漏
 */
public class DWDKeyMoreGoodsProcessor extends RichMapFunction<ODSKeyMoreGoodsRecord, DWDKeyMoreGoodsRecord> {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DWDKeyMoreGoodsProcessor.class);
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        // 初始化并缓存 DWD 字段
        Field[] fields = DWDKeyMoreGoodsRecord.class.getDeclaredFields();
        ...
        for (Method method : ODSKeyMoreGoodsRecord.class.getMethods()) {
        ...
        LOGGER.info("DWDKeyMoreGoodsProcessor 初始化完成: 缓存 {} 个DWD字段, {} 个ODS getter",
    ...
    public void close() throws Exception {
        ...
        LOGGER.info("DWDKeyMoreGoodsProcessor 资源已释放");
        super.close();
    }

    @Override
    public DWDKeyMoreGoodsRecord map(ODSKeyMoreGoodsRecord odsRecord) throws Exception {
        DWDKeyMoreGoodsRecord dwdRecord = new DWDKeyMoreGoodsRecord();
     ...
     */
    private String extractFieldValue(ODSKeyMoreGoodsRecord source, String field) {
