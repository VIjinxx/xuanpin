...
/**
 * DWD层数据处理器 - 关键词搜索页商品数据
 * 使用 RichMapFunction 管理生命周期，避免类加载器泄漏
 */
public class DWDKeyGoodsProcessor extends RichMapFunction<ODSKeyGoodsRecord, DWDKeyGoodsRecord> {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DWDKeyGoodsProcessor.class);
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        // 初始化并缓存 DWD 字段
        Field[] fields = DWDKeyGoodsRecord.class.getDeclaredFields();
        ...
        for (Method method : ODSKeyGoodsRecord.class.getMethods()) {
        ...
        LOGGER.info("DWDKeyGoodsProcessor 初始化完成: 缓存 {} 个DWD字段, {} 个ODS getter",
    ...
    public void close() throws Exception {
        ...
        LOGGER.info("DWDKeyGoodsProcessor 资源已释放");
        super.close();
    }

    @Override
    public DWDKeyGoodsRecord map(ODSKeyGoodsRecord odsRecord) throws Exception {
        DWDKeyGoodsRecord dwdRecord = new DWDKeyGoodsRecord();
     ...
     */
    private String extractFieldValue(ODSKeyGoodsRecord source, String field) {
