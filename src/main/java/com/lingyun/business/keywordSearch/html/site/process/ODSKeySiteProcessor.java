...
/**
 * ODS层数据处理器 - 关键词搜索页站点数据
 * 使用 RichMapFunction 管理生命周期，避免类加载器泄漏
 */
public class ODSKeySiteProcessor extends RichMapFunction<String, ODSSiteRecord> {
    private static final long serialVersionUID = 1L;
    private static final String CONFIG_FILE = "mappingFile/keywordSearch/html/site/ods_key_site_mapping.json";
