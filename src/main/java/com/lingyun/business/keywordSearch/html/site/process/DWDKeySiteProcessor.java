package com.lingyun.business.keywordSearch.html.site.process;
...
/**
 * DWD层数据处理器 - 关键词搜索页站点数据
 * 使用 RichMapFunction 管理生命周期，避免类加载器泄漏
 */
public class DWDKeySiteProcessor extends RichMapFunction<ODSSiteRecord, DWDSiteRecord> {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DWDKeySiteProcessor.class);
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        LOGGER.info("DWDKeySiteProcessor 初始化完成: 缓存 {} 个DWD字段, {} 个ODS getter",
    ...
    public void close() throws Exception {
        ...
        LOGGER.info("DWDKeySiteProcessor 资源已释放");
        super.close();
    }
