package com.lingyun.business.storeDetail.mall.job;
...
import com.lingyun.business.storeDetail.mall.process.DWDMallsProcessor;
import com.lingyun.business.storeDetail.mall.process.ODSMallsProcessor;
import com.lingyun.business.storeDetail.mall.sink.DorisBatchSink;
...
public class FlinkMallJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> sourceStream = JobSourceFactory.createSourceStream(
                env, args, "storeDetail", "store-detail-mall",
                "storeDetail", "samples/店铺详情页.json");
